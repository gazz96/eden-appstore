                ...
                <LinearGradient
                  ...
                  <Text
                    style={{
                      ...
                      levelDescription.set("The equivalent of collecting EDC is 15 % cash back from your bills.\n\nTo reach the Gold status you need to spend 15.000.000 IDR in one of the Eden venues. Gold status is equivalent to 1.000 EDC.")
                      setShow(1)
            ...
            <View style={{ flex: 1 }}>
              <View
                ...
                <View style={{ width: '25%' }}>
                  <TouchableOpacity
                    onPress={() => {
                      openInAppBrowser('https://drive.google.com/file/d/154HMqxk0Svg0_L94rI6cpxddx5XWCeQw/view?tpclid=facebook.PAAaZdwcOzf6rN4_lJN8So3pDeND43m9r9M3nGqvdBCDlg5VXjtwVB4e2kNo4');
                    }}>
                    <Image
